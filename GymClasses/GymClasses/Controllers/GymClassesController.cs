...
namespace GymClasses.Controllers
{
    public class GymClassesController : Controller
    {
        ...
        public ActionResult BookingToggle(int id)
        {
            ...
            if(CurrentClass.AttenddingMembers.Contains(CurrentUser))
            {
                CurrentClass.AttenddingMembers.Remove(CurrentUser);
                db.SaveChanges();
            }
            else
            {
                CurrentClass.AttenddingMembers.Add(CurrentUser);
            }
